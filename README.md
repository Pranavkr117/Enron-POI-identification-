...
SelectKBest is a feature selection technique that chooses the best features according to k highest scores. I chose SelectKBest for feature selection.
...
I eventually used AdaBoostClassifier. The following table shows the results of my preliminary exploration on various classifiers. The top shows metrics from using SelectKBest as feature selection and the bottom table shows metrics from using PCA.
 ...
 But from these results, I was able to see that the best classifiers are:
...
Precision is a measure of how many real POI's there are in the predicted POI's. Recall is the measure of how much the algorithm was able to identify all of the real POI's.
